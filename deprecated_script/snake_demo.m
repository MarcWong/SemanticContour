    ...
    I = imread('/Users/marcWong/Dataset/snake/out1_patch0_6.jpg');
    ...
    x=[];y=[];c = 1;N=100;
    snakeInit = imread('/Users/marcWong/Dataset/snake/out1_patch0_6_segContour.jpg');
    if(size(snakeInit,3)==3), I=rgb2gray(I); end
    while(c<N)    
        for ii = 1:512
            for jj = 1:512
                if snakeInit(ii,jj) > 128
                    x = [x ii];
                    y = [y jj];
                    c = c+1;
                end
